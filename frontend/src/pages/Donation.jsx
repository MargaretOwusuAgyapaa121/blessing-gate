      ...
      <section className="donation-flyer-section">
        <div className="flyer-container">
          ...
          <div className="flyer-info">
            ...
            <h3>How to Donate:</h3>
            <ul>
              <li>WhatsApp: <a href="https://wa.me/233542943584" target="_blank" rel="noopener noreferrer">+233 20 123 4567</a></li>
              <li>Email: <a href="mailto:info@blessinggates.org">info@blessinggates.org</a></li>
              <li>Bank Transfer: Account No. 123456789 (Blessing Gates Foundation)</li>
            </ul>
            <a href="https://wa.me/233542943585" className="btn-primary" target="_blank" rel="noopener noreferrer">
